...
<?php } ?>
		...
		<div id="sidebar2">
      <div id="sidebar_menu">
        <a id="sidebar_menu__close" title="На главную" href="<?php bloginfo('url'); ?>">     </a>
        <div id="sidebar_menu__line_above">
        </div>
        <a id="sidebar_menu__clip_to_evernote" title="Wifi и сети" href="http://variable.pp.ua/category/wifi/">        </a>
        <a id="sidebar_menu__highlight_to_evernote" title="Wordpress" href="http://variable.pp.ua/category/wordpress/">        </a>
        <a id="sidebar_menu__settings" title="Php" href="http://variable.pp.ua/category/php/"></a>
        <!--<a id="sidebar_menu__print" title="Все о играх" href="<?php bloginfo('url'); ?>/games/">        </a> -->
        <a id="sidebar_menu__aqua" title="Аква" href="http://variable.pp.ua/category/aqua/">        </a>
		<a id="sidebar_menu__speak" title="Архив" href="<?php bloginfo('url'); ?>/category/archive/">        </a>
        <div id="sidebar_menu__line_below">
        </div>
      </div>
    </div>
